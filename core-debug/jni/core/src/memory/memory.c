...
#if defined(__x86_64__) || defined(NO_ASM) || !defined(__i386__)
...
/*
#define MAX_COMMAND_LENGTH 128  // max length of executed command line;
#define MAX_COMMAND_OUTPUT_LENGTH 128  // max length of output from executed commands;
char cmdBuffer[MAX_COMMAND_LENGTH];
char outBuffer[MAX_COMMAND_OUTPUT_LENGTH];
*/
