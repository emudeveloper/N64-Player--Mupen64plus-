...
if( setRenderingCallback == NULL )
	printf( "    setRenderingCallback NULL" );
...
if( fBGetFrameBufferInfo == NULL )
	printf( "    fBGetFrameBufferInfo NULL" );
