...
const char *fragmentFooter = "gl_FragColor = comb;	        \n"\
...
void COGL_FragmentProgramCombiner::InitCombinerCycleFill(void)
{
	...
	glUniform4fv(fillColorLocation,1, GetEnvColorfv());
	OPENGL_CHECK_ERRORS;
}
...
void COGL_FragmentProgramCombiner::GenerateProgramStr()
{
    ...
    strcpy(oglNewFP,"#version " GLSL_VERSION "\n");
    if (bNeedT0)
