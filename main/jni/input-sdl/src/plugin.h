...
typedef struct
{
    ...
    SDLKey key;         // sdl keysym; SDLK_UNKNOWN if not assigned   // For SDL 1.3, SDL_SCANCODE_UNKNOWN
...
typedef struct
{
    ...
    SDLKey key_a, key_b;            // up/down or left/right; SDLK_UNKNOWN if not assigned  // For SDL 1.3, SDL_SCANCODE_UNKNOWN
