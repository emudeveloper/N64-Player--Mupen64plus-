...
public class MenuSettingsAudioChangeActivity extends ListActivity implements IFileChooser
{
    ...
    public void onCreate( Bundle savedInstanceState )
    {
        ...
        optionList.add( new MenuOption( "Import...", "add new audio plug-in", "MenuSettingsAudioChangeImport" ) );
    ...
    public void fileChosen( String filename )
    {
        if( filename == null )
        {
            Log.e( "MenuSettingsAudioChangeActivity", "filename null in method fileChosen" );
            return;
        }
        ...
        if( pluginName == null )
        {
            Log.e( "MenuSettingsAudioChangeActivity", "plug-in name null in method fileChosen" );
            return;
        }
    ...
    protected void onListItemClick( ListView listView, View view, int position, long id )
    {
        ...
        else
        {
            if(  MenuSettingsAudioActivity.mInstance != null )
                 MenuSettingsAudioActivity.mInstance.fileChosen( menuOption.info );
            mInstance.finish();
        }
    }
}
