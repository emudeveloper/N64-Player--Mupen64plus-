...
public class MenuSkinsGamepadActivity extends ListActivity
{
    ...
    public void onCreate( Bundle savedInstanceState )
    {
        ...
        optionList.add( new MenuOption( "Change Layout", chosenGamepad, "menuSkinsGamepadChange" ) );
        optionList.add( new MenuOption( "Redraw All", "slower, fixes missing buttons bug", "menuSkinsGamepadRedraw", redrawAll ) );
        optionList.add( new MenuOption( "Accurate N64 Stick", "emulate analog as octagon", "menuSkinsGamepadOctagon", analogAsOctagon ) );
        optionList.add( new MenuOption( "Display FPS", "show the frames-per-second", "menuSkinsGamepadFPS", showFPS ) );
        optionList.add( new MenuOption( "Enable", "use the virtual gamepad", "menuSkinsGamepadEnabled", enabled ) );
    ...
    protected void onListItemClick( ListView listView, View view, int position, long id )
    {
        ...
        else if( menuOption.info.equals( "menuSkinsGamepadRedraw" ) ) 
        {
            ...
            optionArrayAdapter.insert( new MenuOption( "Redraw All", "slower, fixes missing buttons bug", "menuSkinsGamepadRedraw",
                                                       redrawAll ), position );
        ...
        else if( menuOption.info.equals( "menuSkinsGamepadOctagon" ) ) 
        {
            ...
            optionArrayAdapter.remove( menuOption );
            optionArrayAdapter.insert( new MenuOption( "Accurate N64 Stick", "emulate analog as an octagon", "menuSkinsGamepadOctagon",
        ...
        else if( menuOption.info.equals( "menuSkinsGamepadFPS" ) ) 
        {
            showFPS = !showFPS;
            optionArrayAdapter.remove( menuOption );
            optionArrayAdapter.insert( new MenuOption( "Display FPS", "show the frames-per-second", "menuSkinsGamepadFPS",
                                                       showFPS ), position );
        ...
        else if( menuOption.info.equals( "menuSkinsGamepadEnabled" ) ) 
        {
            enabled = !enabled;
            optionArrayAdapter.remove( menuOption );
            optionArrayAdapter.add( new MenuOption( "Enable", "use the virtual gamepad", "menuSkinsGamepadEnabled",
                                                    enabled ) );
