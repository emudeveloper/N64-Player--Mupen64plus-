...
public class MenuSettingsRSPChangeActivity extends ListActivity implements IFileChooser
{
    ...
    public void onCreate( Bundle savedInstanceState )
    {
        ...
        optionList.add( new MenuOption( "Import...", "add new RSP plug-in", "MenuSettingsRSPChangeImport" ) );
    ...
    public void fileChosen( String filename )
    {
        if( filename == null )
        {
            Log.e( "MenuSettingsRSPChangeActivity", "filename null in method fileChosen" );
            return;
        }
        ...
        if( pluginName == null )
        {
            Log.e( "MenuSettingsRSPChangeActivity", "plug-in name null in method fileChosen" );
            return;
        }
    ...
    protected void onListItemClick( ListView listView, View view, int position, long id )
    {
        ...
        else
        {
            if(  MenuSettingsRSPActivity.mInstance != null )
                 MenuSettingsRSPActivity.mInstance.fileChosen( menuOption.info );
            mInstance.finish();
        }
    }
}
